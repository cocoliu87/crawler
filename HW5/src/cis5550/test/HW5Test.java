...
// TODO: implement delete (both public) 
// TODO: add more internal test cases (maybe?), but in any case adjust number of points and rubric
...
public class HW5Test extends GenericTest {
  ...
  void runSetup() throws Exception {
    ...
    String xtable = "pt-"+randomAlphaNum(4,4);
    String xrow = randomAlphaNum(4,9);
  ...
  void runTests(Set<String> tests) throws Exception {
    ...
    if (tests.contains("wdisk")) try {
      ...
      String thetable = "pt-"+randomAlphaNum(3,4);
    ...
    if (tests.contains("putget2")) try {
      ...
      String xtable = "pt-"+randomAlphaNum(3,4);
    ...
    /*if (tests.contains("delete")) try {
      ...
      String table2 = "pt-"+randomAlphaNum(3,4);
      String row1a = randomAlphaNum(6,8);
      String col1a = randomAlphaNum(6,8);
      String val1a = randomAlphaNum(6,8);
      String row2a = randomAlphaNum(6,8);
      String col2a = randomAlphaNum(6,8);
      String val2a = randomAlphaNum(6,8);
      String row2b = randomAlphaNum(6,8);
    ...
    if (tests.contains("rename")) try {
      ...
      s = openSocket(8001);
      out = new PrintWriter(s.getOutputStream());
      String newtable = randomAlphaNum(3,4);
...
*/
    ...
    if ((args.length > 0) && args[0].equals("auto")) {
      ...
      System.out.println("HW5 autograder v1.1 (Sep 17, 2023)");
      System.exit(1);
    }
